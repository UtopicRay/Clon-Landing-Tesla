...
export function LandingHeader() {
    return (
        <header id='landing-header'
                className='py-3 px-10 flex fixed items-center top-0 w-full justify-between z-40 text-white'>
            <div className='flex flex-grow basis-0'>
                <svg className='h-6 w-32 text-current' viewBox="0 0 342 35"
            ...
            <nav>
                <ul className='flex [&>li>a]:inline-block [&>li>a]:text-current [&>li>a]:px-4 [&>li>a]:py-2 [&>li>a]:text-base'>
                    <li className='relative'>
                        <a className="hover:transition-colors hover:bg-gray-400 rounded hover:visible"  href='#'>Vehicles</a>
                    </li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Energy</a></li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Charging</a>
                    </li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Discover</a>
                    </li>
