...
export function LandingHeader(){
    return(
        <header id='landing-header'className='py-3 px-10 flex fixed items-center top-0 w-full justify-between z-40 text-white'>
            <div className='flex flex-grow basis-0'><svg className='h-6 w-32 text-current' viewBox="0 0 342 35"
            ...
            <nav>
                <ul className='flex [&>li>a]:inline-block [&>li>a]:text-current [&>li>a]:px-4 [&>li>a]:py-2 [&>li>a]:text-base'>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Vehicles</a></li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Energy</a></li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Charging</a></li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded"href='#'>Discover</a></li>
                    <li><a className="hover:transition-colors hover:bg-gray-400 hover:rounded" href='#'>Shop</a></li>
                </ul>
            </nav>
            <div className='flex flex-grow justify-end basis-0 text-current'>
                <nav>
                    <ul className='flex [&>li>a]:inline-block [&>li>a]:py-2'>
                        <li><a>
                            <svg className="h-6 w-18 m-0 px-1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li><a>
                            <svg className="h-6 w-18 px-1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="currentColor"
                        ...
                        <li><a>
                            <svg className="h-6 w-18 px-1" viewBox="0 0 24 24"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill="currentColor"
