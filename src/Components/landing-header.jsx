...
export function LandingHeader(){
    return(
        <header className='py-3 px-10 flex fixed items-center top-0 w-full justify-between z-40'>
            <div className='flex flex-grow basis-0'><svg className='h-6 w-32 text-white' viewBox="0 0 342 35"
            ...
            <nav>
                <ul className='flex [&>li>a]:inline-block [&>li>a]:text-white [&>li>a]:px-2 [&>li>a]:py-2'>
            ...
            <div className='flex flex-grow justify-end basis-0 text-white'>
                <nav>
